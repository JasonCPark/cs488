...
reflStone = gr.material({0.0, 0.0, 0.0}, {0.9, 0.9, 0.9}, 0, 1.5)
gold = gr.material({0.9, 0.8, 0.4}, {0.8, 0.8, 0.4}, 25)
wood = gr.material({0.4, 0.2, 0.0}, {0.0, 0.0, 0.0}, 0)
...
buckyball:set_material(reflStone)
buckyball:scale(1, 1, 1)
buckyball:translate(-7,2,0)

buckyball2 = gr.mesh( 'buckyball2', 'Assets/buckyball.obj' )
scene:add_child(buckyball2)
buckyball2:set_material(reflStone)
buckyball2:scale(1, 1, 1)
buckyball2:translate(7,2,0)

tree = gr.mesh( 'tree', 'Assets/tree.obj' )
scene:add_child(tree)
tree:set_material(stone)
tree:scale(1, 1, 1)
